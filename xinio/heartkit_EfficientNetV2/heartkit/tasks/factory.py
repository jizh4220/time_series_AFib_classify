...
from .AFIB_Ident import AFIB_Ident
from .beat import Beat
from .denoise import Denoise
from .segmentation import Segmentation
from .task import HKTask

_tasks: dict[str, HKTask] = {"arrhythmia": Arrhythmia, "AFIB_Ident": AFIB_Ident, "beat": Beat, "segmentation": Segmentation, "denoise": Denoise}
